...
class OrbShaderPainter extends CustomPainter {
  ...
  @override//from the CustomPainter class , defines the painting behavior
  void paint(Canvas canvas, Size size) {
    //fov: field of view,,The clamp method ensures that the zoom value is within the range of 0.0 to 1.0.
...
//Each value is assigned to a specific index on the shader object.
...
/*This is another overridden method from the CustomPainter class.
 It determines whether the painter should repaint based on changes in the shader,
 config, time, mousePos, or energy properties. If any of these properties have changed,
 it returns true to indicate that a repaint is necessary.*/
  @override
